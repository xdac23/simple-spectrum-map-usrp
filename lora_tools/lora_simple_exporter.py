...
class simple_exporter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "simple_exporter")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/dan/Workspace/Gnuradio_scripts/Measurements/C4/c4-lora-short.dat', False)
...
def main(top_block_cls=simple_exporter, options=None):
