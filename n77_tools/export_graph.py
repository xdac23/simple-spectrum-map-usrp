...
# Range of spans
span_range = range(1,2)

# Iterate over the span range
for span in span_range:
    # Generate file paths for the current span
    file_paths = [root_path + 'C{}/c{}-n77-{}.dat'.format(i, i, span) for i in range(1, 5)]
    ...
    plt.gca().tick_params(axis='y', which='both', left=True, labelleft=True)  # Hide y-axis ticks and labels
