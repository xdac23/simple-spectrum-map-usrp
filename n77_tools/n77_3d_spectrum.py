...
file_path = root_path + f'C4/c4-n77-{span}.dat'
...
fs = 20e6  # Sample rate (10 MHz)
f_c = 3300e6 + (fs*span)  # Central frequency (868 MHz)
...
ax.set_title('3D Spectrum of span number {}'.format(span))
