...
class n77_simple_plot(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "n77_simple_plot", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("n77_simple_plot")
        ...
        self.settings = Qt.QSettings("GNU Radio", "n77_simple_plot")
        ...
        # Blocks
        ##################################################
        self._iteration_range = Range(1, 45, 1, 1, 200)
...
def main(top_block_cls=n77_simple_plot, options=None):
